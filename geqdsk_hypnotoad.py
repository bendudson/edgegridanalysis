#!/usr/bin/env python3
#
# This script generates a Hypnotoad input YAML file from a GEQDSK equilibrium
#
# Example
#
#     ./geqdsk_hypnotoad neqdsk -o neqdsk.yaml
#
...
def main(*_args):
    ...
    parser.add_argument('-o', '--output', default="hypnotoad.yaml", help="YAML file for Hypnotoad")
    ...
    with open(args.output, 'w') as f:
        f.write(edgegridanalysis.output.to_yaml(eq_type.to_hypnotoad_dict()))
